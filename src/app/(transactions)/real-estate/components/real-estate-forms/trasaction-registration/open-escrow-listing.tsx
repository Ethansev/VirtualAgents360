...
import { numberValidation, stringWithMinLength } from '@/utils/utils';
...
export default function OpenEscrowListingForm(props: Props) {
    ...
    async function onSave(formData: FieldValues) {
        ...
        const data = {
            ...
            transactionRegistration: {
                ...
                openEscrowListing: { ...formData } as OpenEscrowListing,
            ...
            <Form register={register} onSubmit={handleSubmit(onSave)}>
                ...
                <div className='space-y-12'>
                    <div className='col-span-full mb-8'>
                        <SectionHeader text={'Smart Buy Combo'} />
                        <SelectInputField
